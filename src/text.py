"""
Text utilities for COCO-QA question processing.

This file handles:
  - simple question tokenization
  - question vocabulary building
  - question encoding/decoding
  - saving/loading question vocabulary

Keep this simple for the first baseline:
  lowercase -> regex tokenization -> integer token IDs
"""
